...
//   .wrapper
//     .summary__photo
//       = image_tag("work/posters-hero.jpg", {:title => "Posters", :alt => "Posters"})
//       .photo__flag
//         %p
//           Creative Direction
//         %h3
...
//         Posters
//       %p
//         Music posters for annual gallery event
//     .summary__credits
//       %ul
//         %li
//           Client:
...
//         %li
//           Role: Creative Direction, Illustration, Print
//     .summary__description
//       %p
//         At the tail end of each summer, AIGA Jacksonville hosts the
//         %a{:href => "alwayssummer"}Always Summer Poster Show + Mixtape.
//         A premiere event for hosting the greater Jacksonville design scene, the organization asks designers to participate in the gallery event. The past six consecutive years, I've been able to submit artwork for the show. I became interested in the event because it married my two favorite loves: design and music. Each year, I attempt to challenge my artistic boundaries.
// .callout
//   .wrapper
//     %p
...
//   .wrapper
//     .details__split
//       = image_tag("work/posters-biggie.jpg", {:title => "Party & Bullshit poster", :alt => "Party & Bullshit poster"})
//     .details__split
//       = image_tag("work/posters-beyonce.jpg", {:title => "Sorry poster", :alt => "Sorry poster"})
// .callout
//   .wrapper
//     %p
...
//   .wrapper
//     .details__split
//       = image_tag("work/posters-cauliflower.jpg", {:title => "Cauliflower poster", :alt => "Cauliflower poster"})
//     .details__split
//       = image_tag("work/posters-escapee.jpg", {:title => "Escapee poster", :alt => "Escapee poster"})
// .callout
//   .wrapper
//     %p
...
//   .wrapper
//     .details__split
//       = image_tag("work/posters-honeybear-1.jpg", {:title => "Honeybear poster white", :alt => "Honeybear poster white"})
//     .details__split
//       = image_tag("work/posters-honeybear-2.jpg", {:title => "Honeybear poster black", :alt => "Honeybear poster black"})
// .callout
//   .wrapper
//     %p
...
//   .wrapper
//     .details__split
//       = image_tag("work/posters-sunmodels.jpg", {:title => "Sun Models poster", :alt => "Sun Models poster"})
//     .details__split
//       = image_tag("work/posters-jamiexx.jpg", {:title => "Good Times poster", :alt => "Good Times poster"})
