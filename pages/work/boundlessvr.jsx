...
//   .wrapper
//     .summary__photo
//       = image_tag("work/boundlessvr-hero.jpg", {:title => "Boundless Florida Virtual Reality", :alt => "Boundless Florida Virtual Reality"})
//       .photo__flag
//         %p
...
//         %li
//           Client:
//           %a{:href => "https://www.enterpriseflorida.com/", :target => "_blank"}Enterprise Florida
//         %li Role: UI/UX, Mobile App Design
//       %ul
//         %li Creative Director: Shane Santiago
//         %li Developers: Mitch Cichocki, Julian Bravard
...
//   .wrapper
//     %p
//       A key takeaway was the VR hub to present the Boundless campaign 360 content in an engaging way that encourages users to shift their perceptions of doing business in Florida. The VR/360 mobile experience tapped into the viewer's innate need to discover and explore by highlighting the ULA rocket launch process. C-level decision makers, site selectors, and consultants would feel as if the launch was at their fingertips.
// .details
//   .wrapper
//     = image_tag("work/boundlessvr-cardboard.jpg", {:title => "Google Cardboard", :alt => "Google Cardboard"})
//   .wrapper
//     .details__split
//       .details__button
//         %a{:href => "https://preview.uxpin.com/b9c84de4530e0999fa06fd14a758f364df3b6b11chd", :target => "_blank"}
...
// .details
//   .wrapper
//     = image_tag("work/boundlessvr-demo.gif", {:title => "VR Demo", :alt => "VR Demo"})
//     .details__button
//       %a{:href => "http://boundlessfloridavr.com/", :target => "_blank"}
//         %button{:type => "button"}Boundless FL VR
// .callout
//   .wrapper
//     %p
...
// .details
//   .wrapper
//     = image_tag("work/boundlessvr-scalable.jpg", {:title => "Additional Videos", :alt => "Additional Videos"})
